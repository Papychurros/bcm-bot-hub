    ...
    sections: [
      {
        ...
        name: 'C.A.S.H',
        description: 'gpt-4o-mini · Google Sheets · Détection automatique d\'intention',
        badges: [
          { icon: '📱', label: 'Telegram' },
        ...
        agents: [
          {
            ...
            tools: ['🔧 Détection catégorie IA', '🔧 Insert Sheets', '🔧 Confirmation Telegram'],
          },
          {
            name: 'Module Consultation',
            color: 'blue',
            subtitle: 'Lecture & recherche',
            tools: ['🔧 Select Sheets', '🔧 Filtrage par date/montant', '🔧 Formatage Telegram'],
          },
          {
            name: 'Module Modification',
            color: 'orange',
            subtitle: 'Modifier & supprimer',
            tools: ['🔧 Update Sheets', '🔧 Delete Sheets', '🔧 Confirmation Telegram'],
          },
          {
            name: 'Module Bilan',
            color: 'purple',
      ...
      { type: 'separator' },
      {
        ...
        steps: [
          ...
          { number: '03', icon: '📊', title: 'Google Sheets', description: 'Exécute l\'opération sur la base de données', color: 'purple' },
